...
$sql = 'SELECT cpu_usage, ram_usage, capacity_mb, remaining_capacity_mb, gpu_usage, percentage_remaining FROM pc'.$pcID.' ORDER BY cpu_usage DESC, ram_usage DESC, (remaining_capacity_mb/capacity_mb)*100 DESC, gpu_usage DESC, percentage_remaining ASC';
