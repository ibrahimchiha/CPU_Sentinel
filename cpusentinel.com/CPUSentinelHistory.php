...
<head>
<link rel="stylesheet" type="text/css" href="CPUSentinelHistoryStyle.css">
  <meta http-equiv="refresh" content="60" >
  <title> CPU Sentinel History </title>
  <meta charset="utf-8">
...
<body style="height:1500px" style ="background: white">
...
<!--  Use flexbox utility classes to change how the child elements are justified  -->
  <div class="collapse navbar-collapse justify-content-between" id="navbarToggle">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active">History</a> <span class="sr-only">(current)</span>
      </li>
      <li class="nav-item">
...
echo "<h1 align='center' style='color:white'> $firstName $lastName </h1>";
?>
<br>



<table  align = "center" class="content-table" width = "850" height = "150">
<thead>
<tr>
    <th> Date and Time </th>
    <th> CPU % </th>
...
if ($firstName == $FirstName && $lastName == $LastName) {
    if ($CpuUsage >= 90 || $RamUsage >= 90|| $DiskUsage >=90 || $BatteryPercentage <= 20)
        echo "<tr class='clickable-row'><a class='showmore'></a><td>"."<font color='#FF6B6B'> $DateAndTime" ;
    else
        echo "<tr class='clickable-row'><a class='showmore'></a><td>". $DateAndTime ;
    ...
    // echo "<td><a href='CPUSentinelHistory.php' style='color:inherit'> View</a></td>";
